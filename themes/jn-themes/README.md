...
- `textBlockQuote.border`/`background`: per-theme, tied to accent (light-darkened accent for the border, accent at low opacity for the background) — Deep Raspberry `#831f51b9`/`#9a245f33`, Deep Teal `#07625bb9`/`#08736b33`, Soft Cobalt `#22488cb9`/`#2855a533`. Feeds the Markdown Inline Editor's live blockquote marker (see that extension's own changelog); previously a leftover shared blue (`#0076c5`) unrelated to any theme's palette.
...
code --install-extension jn-themes-0.3.7.vsix
```
