...
- **(list)** second-level bullet glyph switched from `○` (white circle) to `◦` (white bullet) — a visibly smaller hollow circle, the conventional sub-bullet glyph.
...
- **(theme)** bullet and numbered list marker fallback now reads `charts.blue` instead of `editor.foreground` — markers were rendering near-black by default whenever `markdownInlineEditor.colors.listMarker` was left unset.

## [1.26.4] - 2026-08-11

### Fixed

- **(theme)** blockquote marker fallback now reads `textBlockQuote.border` instead of `textLink.foreground` — the marker was inheriting the link-hover color by accident whenever `markdownInlineEditor.colors.blockquote` was left unset.

## [1.26.3](https://github.com/SeardnaSchmid/markdown-inline-editor-vscode/compare/v1.26.2..v1.26.3) - 2026-08-10

### Fixed

- **(code)** reveal inline code during selection - ([6651b89](https://github.com/SeardnaSchmid/markdown-inline-editor-vscode/commit/6651b897ae33082d654e49bbe1d4363079fd58f0))

## [1.26.2](https://github.com/SeardnaSchmid/markdown-inline-editor-vscode/compare/v1.26.1..v1.26.2) - 2026-08-10

### Fixed

- **(theme)** distinguish mango paper selections - ([240dd88](https://github.com/SeardnaSchmid/markdown-inline-editor-vscode/commit/240dd88de91b492bc0491a26dd4638d89efe62cb))
